...
url = "https://sabrinahill.xyz/websecurity/index.php"
print("Opening " + url)
start = time.clock()
...
url = "https://sabrinahill.xyz/websecurity/login.php"
print("Opening " + url)
start = time.clock()
response = urllib.urlopen(url)
elapsed = time.clock() - start
...
url = "https://sabrinahill.xyz/websecurity/forgotpass.php"
print("Opening " + url)
start = time.clock()
response = urllib.urlopen(url)
elapsed = time.clock() - start
...
url = "https://sabrinahill.xyz/websecurity/topic.php"
print("Opening " + url)
start = time.clock()
response = urllib.urlopen(url)
elapsed = time.clock() - start
